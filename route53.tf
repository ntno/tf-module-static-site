...
resource "aws_route53_record" "domain_to_content_bucket" {
  ...
  alias {
    name                   = aws_s3_bucket.s3_content_bucket.website_domain #aws_s3_bucket_website_configuration.s3_content_bucket_website_configuration.website_endpoint
...
resource "aws_route53_record" "www_subdomain_to_www_bucket" {
  ...
  alias {
    name                   = aws_s3_bucket.s3_www_subdomain_bucket.website_domain #aws_s3_bucket_website_configuration.s3_www_subdomain_bucket_website_configuration.website_endpoint
